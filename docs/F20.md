...
<p>Set the party’s <code>.details.scale</code> to ‘large’</p>
      ...
      <tr>
        ...
        <td>
<p>Add an <code>Amendment</code> object to the contract’s <code>.amendments</code> array, and set its <code>.id</code> (string) sequentially, across all F20 notices for this procedure. (The first notice sets it to ‘1’, the second to ‘2’, etc.)</p>
        </td>
      </tr>
      <tr>
