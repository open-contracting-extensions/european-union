...
<p>Map to <code>tender.techniques.frameworkAgreement.durationRationale</code></p>
      ...
      <tr>
        ...
        <td><a href="#/OBJECT_CONTRACT/OBJECT_DESCR/JUSTIFICATION">See above</a></td>
      </tr>
      <tr>
  ...
  <table class="docutils">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
<p>Discard. The <em>contract award notice concerning this contract</em> is the OCDS release with the same <code>ocid</code> as this release, with ‘award’ in its <code>tag</code>, and with an earlier <code>date</code> that is nearest that of this release.</p>
        </td>
      </tr>
  </table>
</div>
...
<p>Set the party’s <code>.details.scale</code> to ‘large’</p>
      ...
      <tr>
        ...
        <td>
<p>Discard. The <em>information on value of the contract/lot/concession (at the time of conclusion of the contract)</em> is available in the OCDS release with the same <code>ocid</code> as this release, with ‘award’ in its <code>tag</code>, and with an earlier <code>date</code> that is nearest that of this release.</p>
        </td>
      </tr>
      <tr>
        <td></td>
  ...
  <table class="docutils">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
<p>Get the <code>Contract</code> object in <code>contracts</code>, get the <code>Item</code> object in <code>tender.items</code>, copy the item to the contract’s <code>.items</code>, and delete the contract’s item’s <code>.classification</code> and <code>.additionalClassifications</code>.</p>
        </td>
      </tr>
      <tr>
...
<p>Map to the contract’s <code>.periodRationale</code></p>
      ...
      <tr>
        ...
        <td><a href="#/MODIFICATIONS_CONTRACT/DESCRIPTION_PROCUREMENT/JUSTIFICATION">See above</a></td>
      </tr>
      <tr>
...
<p>There’s an open issue (<a href="https://github.com/open-contracting/standard/issues/232">#232</a>) relevant to removing previous entries from the <code>parties</code> and <code>.suppliers</code> arrays. <span class="badge badge-issue">Issue</span></p>
      ...
      <tr>
        ...
        <td><a href="#/AWARD_CONTRACT/AWARDED_CONTRACT/CONTRACTORS/CONTRACTOR/SME">See above</a></td>
      </tr>
      <tr>
        <td></td>
        ...
        <td><a href="#/AWARD_CONTRACT/AWARDED_CONTRACT/CONTRACTORS/CONTRACTOR/NO_SME">See above</a></td>
      </tr>
      <tr>
...
<p>Map to the amendment’s <code>.description</code></p>
      ...
      <tr>
        ...
        <td>
<p>Prefix by the translation of “Need for additional works, services or supplies by the original contractor/concessionaire: “, and map to the amendment’s <code>.rationale</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td><a href="#/MODIFICATIONS_CONTRACT/INFO_MODIFICATIONS/ADDITIONAL_NEED">See above</a></td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Prefix by the translation of “Need for modification brought about by circumstances which a diligent contracting authority/entity could not foresee: “, and map to the amendment’s <code>.rationale</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td><a href="#/MODIFICATIONS_CONTRACT/INFO_MODIFICATIONS/UNFORESEEN_CIRCUMSTANCE">See above</a></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
<p>Discard. The <em>updated total contract value before the modifications</em> is available in the OCDS release with the same <code>ocid</code> as this release, with ‘contract’ or ‘contractUpdate’ in its <code>tag</code>, and with an earlier <code>date</code> that is nearest that of this release.</p>
        </td>
      </tr>
      <tr>
        <td></td>
