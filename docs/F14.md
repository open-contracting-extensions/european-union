...
<p>Map to <code>date</code></p>
      ...
      <tr>
        ...
        <td>
<p>Discard. The <em>original notice reference</em> is the OCDS release with the same <code>ocid</code> as this release, with ‘tender’ in its <code>tag</code>, and with an earlier <code>date</code> that is nearest that of this release.</p>
        </td>
      </tr>
  </table>
</div>
...
<p>Add an <code>Amendment</code> object to the <code>tender.amendments</code> array, and set its <code>.id</code>.</p>
      ...
      <tr>
        ...
        <td colspan="2" id="/CHANGES/CHANGE">
