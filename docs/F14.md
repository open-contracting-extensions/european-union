...
<p>Map to <code>date</code></p>
      ...
      <tr>
        ...
        <td>
<p>Discard. The <em>original notice reference</em> is the OCDS release with the same <code>ocid</code> as this release, with ‘tender’ in its <code>tag</code>, and with the nearest earlier <code>date</code> to this release.</p>
        </td>
      </tr>
  </table>
</div>
