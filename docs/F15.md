...
<p>Map to <code>tender.title</code></p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>tender.id</code> (string)</p>
        </td>
      </tr>
      <tr>
...
<p>Discard. This is derived from the <code>value</code> of awards.</p>
      ...
      <tr>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘lowestValidBidValue’, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘highestValidBidValue’, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Map to the contract’s <code>.value.amount</code></p>
      ...
      <tr>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘lowestValidBidValue’, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘highestValidBidValue’, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
