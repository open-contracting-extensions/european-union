  ...
  <table class="docutils">
    ...
    <tbody>
      <tr>
        ...
        <td>
<p>If unchecked, Add ‘planning’ to <code>tag</code>, and set <code>tender.status</code> to ‘planned’. If checked, add ‘planning’ and ‘tender’ to <code>tag</code>, and set <code>tender.status</code> to ‘active’.</p>
        </td>
      </tr>
  </table>
</div>
