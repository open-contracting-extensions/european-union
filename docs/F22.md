...
<p>Map to the contract’s <code>.dateSigned</code></p>
      ...
      <tr>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘bids’, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘smeBids’, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘foreignBidsFromEU’,, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘foreignBidsFromNonEU’,, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘electronicBids’,, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
