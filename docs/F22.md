...
<p>Map to <code>.contactPoint.faxNumber</code></p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>.details.url</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/8">#8</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.details.buyerProfile</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/7">#7</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Discard. If there are multiple parties with the role ‘buyer’, then the contract involves joint procurement. (When <em>The contract involves joint procurement</em> is checked, at least one additional contracting authority is provided.)</p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>tender.crossBorderLaw</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/12">#12</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add ‘centralPurchasingBody’ to the <code>.roles</code> of the party <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/11">#11</a></span></p>
        </td>
      </tr>
      <tr>
        <td>I.3</td>
...
<p>Otherwise, <a href="../operations#add-a-party">add a party</a>, add ‘processContactPoint’ to its <code>.roles</code>, and set its <a href="#/CONTRACTING_BODY/ADDRESS_CONTRACTING_BODY/OFFICIALNAME">fields as above</a>. <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/9">#9</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p><em>If ‘electronically via’ is checked, this results in a loss of structure.</em> <span class="badge badge-warning">Attention</span></p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>tender.communicationDetails.accessToolUrl</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/13">#13</a></span></p>
        </td>
      </tr>
      <tr>
        <td>I.6</td>
        ...
        <td>
<p>Get the <code>Organization</code> object for the buyer, and add a <code>Classification</code> object to its <code>.details.classifications</code> array. Set the classification’s <code>.scheme</code> to ‘TED_CE_ACTIVITY’, and set its <code>.id</code> as follows: <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/10">#10</a></span></p>
...
<p>Map to <code>tender.id</code></p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>tender.classification.scheme</code> to ‘CPV’, take the CPV code in the <code>CODE</code> attribute, and map to <code>tender.classification.id</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/15">#15</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/OBJECT_CONTRACT/VAL_TOTAL/@PUBLICATION">
          <p><i>Unlabeled</i><br><code>/OBJECT_CONTRACT/VAL_TOTAL/@PUBLICATION</code></p>
        </td>
        <td>
...
<p>Map to the time component of <code>tender.tenderPeriod.endDate</code></p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>tender.submissionLanguages</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/23">#23</a></span></p>
        </td>
      </tr>
      <tr>
        <td>IV.2.5</td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/AWARD_CONTRACT/AWARDED_CONTRACT/TENDERS/@PUBLICATION">
          <p><i>Unlabeled</i><br><code>/AWARD_CONTRACT/AWARDED_CONTRACT/TENDERS/@PUBLICATION</code></p>
        </td>
        <td>
<p><em>Pending guidance from F06</em></p>
        </td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/AWARD_CONTRACT/AWARDED_CONTRACT/CONTRACTORS/@PUBLICATION">
          <p><i>Unlabeled</i><br><code>/AWARD_CONTRACT/AWARDED_CONTRACT/CONTRACTORS/@PUBLICATION</code></p>
        </td>
        <td>
<p><em>Pending guidance from F06</em></p>
        </td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/AWARD_CONTRACT/AWARDED_CONTRACT/VALUES/@PUBLICATION">
          <p><i>Unlabeled</i><br><code>/AWARD_CONTRACT/AWARDED_CONTRACT/VALUES/@PUBLICATION</code></p>
        </td>
        <td>
<p><em>Pending guidance from F06</em></p>
        </td>
  ...
  <table class="docutils">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
<p>Add ‘electronicOrdering’ to <code>tender.techniques</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/5">#5</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p><a href="../operations#add-a-party">Add a party</a>, and add ‘reviewBody’ to its <code>.roles</code></p>
      ...
      <tr>
        ...
        <td>
<p><a href="../operations#add-a-party">Add a party</a>, and add ‘mediationBody’ to its <code>.roles</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/4">#4</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>tender.reviewDetails</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/6">#6</a></span></p>
        </td>
      </tr>
      <tr>
        <td>VI.4.4</td>
        ...
        <td>
<p><a href="../operations#add-a-party">Add a party</a>, and add ‘reviewContactPoint’ to its <code>.roles</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/4">#4</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
