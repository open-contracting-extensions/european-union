...
<p>Map to the award’s <code>.subcontracting.details</code> <span class="badge badge-proposal"><a href="https://github.com/open-contracting-extensions/european-union/issues/37">Proposal #37</a></span></p>
      ...
      <tr>
        ...
        <td>
<p>Discard. If <em>Bargain purchase taking advantage of a particularly advantageous opportunity available for a very short time at a price considerably lower than market prices</em> is checked in Annex D2</p>
        </td>
      </tr>
      <tr>
        <td></td>
