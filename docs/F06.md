...
<p>Discard. If <code>tender.lots</code> isn’t set, then the contract isn’t divided into lots.</p>
      ...
      <tr>
        <td>II.1.7</td>
        <td colspan="2">
          <p>Total value of the procurement <i>(excluding VAT)</i> <i>(Agree to publish?)</i></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td><a href="#/OBJECT_CONTRACT/LOT_DIVISION">See above</a></td>
      </tr>
      <tr>
        <td></td>
        <td>
        ...
        <td><a href="#/OBJECT_CONTRACT/NO_LOT_DIVISION">See above</a></td>
      </tr>
      <tr>
        <td></td>
...
<p><em>If the contract isn’t divided into lots, this results in a loss of structure.</em> <span class="badge badge-warning">Attention</span></p>
      ...
      <tr>
        ...
        <td colspan="2" id="/OBJECT_CONTRACT/OBJECT_DESCR/AC">
          <p>Award criteria <i>(Agree to publish?)</i><br><code>/OBJECT_CONTRACT/OBJECT_DESCR/AC</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        <td id="/OBJECT_CONTRACT/OBJECT_DESCR/AC/@PUBLICATION">
          <p><i>Unlabeled</i><br><code>/OBJECT_CONTRACT/OBJECT_DESCR/AC/@PUBLICATION</code></p>
        </td>
        <td>
          <p><i>Need to integrate prior work</i></p>
        </td>
...
<p>Discard. If there is no corresponding <code>Options</code> object in the <code>tender.options</code> array, then there are no options.</p>
      ...
      <tr>
        ...
        <td>
<p>Set the options’ <code>.description</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/21">#21</a></span></p>
        </td>
      </tr>
      <tr>
        <td>II.2.13</td>
...
<p>Discard. If ‘GPA’ isn’t in <code>tender.coveredBy</code>, then the procurement isn’t covered by the GPA.</p>
      ...
      <tr>
        ...
        <td id="/PROCEDURE/NOTICE_NUMBER_OJ">
          <p>Notice number in the OJ S <i>(One of the following)</i> <i>(Periodic indicative notice – utilities, used as a call for competition)</i><br><code>/PROCEDURE/NOTICE_NUMBER_OJ</code></p>
        </td>
        <td>
<p><em>Pending guidance from F02</em></p>
        </td>
      ...
      <tr>
        <td></td>
        <td colspan="2">
          <p>Contract notice – utilities <i>(Qualification system – utilities, used as a call for competition)</i></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/AWARD_CONTRACT/AWARDED_CONTRACT/TENDERS">
          <p>Information about tenders <i>(Agree to publish?)</i><br><code>/AWARD_CONTRACT/AWARDED_CONTRACT/TENDERS</code></p>
        </td>
        <td>
<p><em>Pending guidance from F03</em></p>
        </td>
      ...
      <tr>
        ...
        <td><a href="#/AWARD_CONTRACT/AWARDED_CONTRACT">See above</a></td>
      </tr>
      <tr>
        <td></td>
        <td>
        ...
        <td><a href="#/AWARD_CONTRACT/NO_AWARDED_CONTRACT">See above</a></td>
      </tr>
      <tr>
        <td></td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/AWARD_CONTRACT/AWARDED_CONTRACT/CONTRACTORS/CONTRACTOR/ADDRESS_CONTRACTOR">
          <p>Name and address of the contractor <i>(Agree to publish?)</i><br><code>/AWARD_CONTRACT/AWARDED_CONTRACT/CONTRACTORS/CONTRACTOR/<wbr>ADDRESS_CONTRACTOR</code></p>
        </td>
        <td>
<p><em>Pending guidance from F03</em></p>
        </td>
      ...
      <tr>
        ...
        <td><a href="#/AWARD_CONTRACT/AWARDED_CONTRACT/CONTRACTORS/AWARDED_TO_GROUP">See above</a></td>
      </tr>
      <tr>
        <td></td>
        <td>
        ...
        <td><a href="#/AWARD_CONTRACT/AWARDED_CONTRACT/CONTRACTORS/NO_AWARDED_TO_GROUP">See above</a></td>
      </tr>
      <tr>
        <td></td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/AWARD_CONTRACT/AWARDED_CONTRACT/VALUES">
          <p>Information on value of the contract/lot <i>(excluding VAT)</i> <i>(Agree to publish?)</i><br><code>/AWARD_CONTRACT/AWARDED_CONTRACT/VALUES</code></p>
        </td>
        <td>
<p><em>Pending guidance from F03</em></p>
        </td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        <td>V.2.7</td>
        <td colspan="2">
          <p>Number of contracts awarded</p>
        </td>
      </tr>
      <tr>
        <td>V.2.8</td>
        <td colspan="2">
          <p>Country of origin of the product or service</p>
        </td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        <td>V.2.9</td>
        <td colspan="2">
          <p>The contract was awarded to a tenderer who submitted a variant</p>
        </td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        <td>V.2.10</td>
        <td colspan="2">
          <p>Tenders were excluded on the ground that they were abnormally low</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/D_REPETITION_EXISTING/@CTYPE">
          <p><i>Unlabeled</i><br><code>/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/<wbr>D_REPETITION_EXISTING/@CTYPE</code></p>
        </td>
        <td>
<p><em>Pending guidance from F03</em></p>
        </td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/D_CONTRACT_AWARDED_DESIGN_CONTEST/@CTYPE">
          <p><i>Unlabeled</i><br><code>/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/<wbr>D_CONTRACT_AWARDED_DESIGN_CONTEST/@CTYPE</code></p>
        </td>
        <td>
<p><em>Pending guidance from F03</em></p>
        </td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/D_COMMODITY_MARKET/@CTYPE">
          <p><i>Unlabeled</i><br><code>/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/<wbr>D_COMMODITY_MARKET/@CTYPE</code></p>
        </td>
        <td>
<p><em>Pending guidance from F03</em></p>
        </td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/D_FROM_WINDING_PROVIDER/@CTYPE">
          <p><i>Unlabeled</i><br><code>/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/<wbr>D_FROM_WINDING_PROVIDER/@CTYPE</code></p>
        </td>
        <td>
<p><em>Pending guidance from F03</em></p>
        </td>
...
<p><em>Pending guidance from F03</em></p>
      ...
      <tr>
        ...
        <td id="/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/D_FROM_LIQUIDATOR_CREDITOR/@CTYPE">
          <p><i>Unlabeled</i><br><code>/PROCEDURE/PT_AWARD_CONTRACT_WITHOUT_CALL/D_ACCORDANCE_ARTICLE/<wbr>D_FROM_LIQUIDATOR_CREDITOR/@CTYPE</code></p>
        </td>
        <td>
<p><em>Pending guidance from F03</em></p>
        </td>
