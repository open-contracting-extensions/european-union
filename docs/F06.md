...
<p>For the <em>Value</em>, discard as above. For the <em>Lowest offer</em> and <em>Highest offer</em>, map to the bid statistic’s <code>.currency</code>.</p>
      ...
      <tr>
        <td></td>
        <td id="/OBJECT_CONTRACT/VAL_RANGE_TOTAL/@CURRENCY">
          <p><i>Unlabeled</i><br><code>/OBJECT_CONTRACT/VAL_RANGE_TOTAL/@CURRENCY</code></p>
        </td>
        <td><a href="#/OBJECT_CONTRACT/VAL_TOTAL/@CURRENCY">See above</a></td>
      </tr>
      <tr>
        <td></td>
        ...
        <td><a href="#/OBJECT_CONTRACT/VAL_TOTAL/@PUBLICATION">See above</a></td>
      </tr>
      <tr>
        <td id="II.2">II.2</td>
...
<p>Map to the lot’s <code>.description</code>, and map to the item’s <code>.description</code></p>
      ...
      <tr>
        ...
        <td><a href="#/AWARD_CONTRACT/AWARDED_CONTRACT/VALUES/@PUBLICATION">See above</a></td>
      </tr>
      <tr>
        <td></td>
        <td>
...
<p>Map to the award’s <code>.subcontracting.details</code> <span class="badge badge-proposal"><a href="https://github.com/open-contracting-extensions/european-union/issues/37">Proposal #37</a></span></p>
      ...
      <tr>
        ...
        <td>
<p>Map to the award’s <code>.bargainPurchase.amount</code> <span class="badge badge-proposal"><a href="https://github.com/open-contracting-extensions/european-union/issues/45">Proposal #45</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to the award’s <code>.bargainPurchase.currency</code> <span class="badge badge-proposal"><a href="https://github.com/open-contracting-extensions/european-union/issues/45">Proposal #45</a></span></p>
        </td>
      </tr>
  </table>
</div>
