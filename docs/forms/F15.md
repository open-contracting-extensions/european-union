...
**Quick links:** [PDF form](../_static/pdf/EN_F15.pdf) | [sample XML](https://github.com/open-contracting/european-union-support/blob/main/output/samples/F15_2014.xml)
...
<p>This assumes the <em>Contract No</em> is unique within the contracting process. <span class="badge badge-warning"><a href="https://github.com/open-contracting-extensions/european-union/issues/93">Attention #93</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Add a <code>Contract</code> object to the <code>contracts</code> array, set its <code>.id</code> and <code>.awardID</code> to the award’s <code>.id</code>, set its <code>.title</code> to the award’s <code>.title</code>, and set its <code>.status</code> to ‘active’.</p>
      ...
      <tr>
        ...
        <td id="/AWARD_CONTRACT/AWARDED_CONTRACT/DATE_CONCLUSION_CONTRACT">
          <p>Date of the award decision of the contract / concession <i>(dd/mm/yyyy)</i><br><code>/AWARD_CONTRACT/AWARDED_CONTRACT/DATE_CONCLUSION_CONTRACT</code></p>
        </td>
        <td>
