...
<p>Get the <code>Organization</code> object for the buyer, and add a <code>Classification</code> object to its <code>.details.classifications</code> array. Set the classification’s <code>.scheme</code> to ‘TED_CA_TYPE’, and set its <code>.id</code> and/or <code>.description</code> as follows:</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘MINISTRY’, and set <code>.description</code> to ‘Ministry or any other national or federal authority, including their regional or local subdivisions’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘NATIONAL_AGENCY’, and set <code>.description</code> to ‘National or federal agency/office’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘REGIONAL_AUTHORITY’, and set <code>.description</code> to ‘Regional or local authority’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘REGIONAL_AGENCY’, and set <code>.description</code> to ‘Regional or local agency/office’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘BODY_PUBLIC’, and set <code>.description</code> to ‘Body governed by public law’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘EU_INSTITUTION’, and set <code>.description</code> to ‘European institution/agency or international organisation’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>(The codes are drawn from <a href="https://eur-lex.europa.eu/legal-content/en/TXT/?uri=CELEX%3A32014L0025#L_2014094EN.01033901">Directive 2014/25/EU</a>)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘PRODUCTION_TRANSPORT_DISTRIBUTION_GAS_HEAT’, and set <code>.description</code> to ‘Production, transport and distribution of gas and heat’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point A)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘RAILWAY_SERVICES’, and set <code>.description</code> to ‘Railway services’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point D)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘ELECTRICITY’, and set <code>.description</code> to ‘Electricity’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point B)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘URBAN_RAILWAY_TRAMWAY_TROLLEYBUS_BUS_SERVICES’, and set <code>.description</code> to ‘Urban railway, tramway, trolleybus or bus services’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point E)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘EXPLORATION_EXTRACTION_GAS_OIL’, and set <code>.description</code> to ‘Extraction of gas and oil’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point G)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘PORT_RELATED_ACTIVITIES’, and set <code>.description</code> to ‘Port-related activities’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point I)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘EXPLORATION_EXTRACTION_COAL_OTHER_SOLID_FUEL’, and set <code>.description</code> to ‘Exploration and extraction of coal and other solid fuels’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point H)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘AIRPORT_RELATED_ACTIVITIES’, and set <code>.description</code> to ‘Airport-related activities’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point J)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘WATER’, and set <code>.description</code> to ‘Water’</p>
...
<p>(Relates to 2014/25/EU Annex 3, point C)</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘POSTAL_SERVICES’, and set <code>.description</code> to ‘Postal services’</p>
...
<p>Add an <code>AwardCriterion</code> object to the lot’s <code>.awardCriteria.criteria</code> array (<code>.awardCriteria</code> is an object), and map to the criterion’s <code>.name</code></p>
      ...
      <tr>
        ...
        <td>
<p>Add an <code>AwardCriterion</code> object to the lot’s <code>.awardCriteria.criteria</code> array (<code>.awardCriteria</code> is an object), set its <code>.type</code> to ‘price’, and set its <code>.name</code> to ‘Lowest price’.</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Discard</p>
      ...
      <tr>
        ...
        <td>
<p>If not set, let <em>Contract No</em> be the notice number followed by a hyphen ‘-‘ followed by the value of the <code>ITEM</code> attribute of the <code>AWARD_CONTRACT</code> element. Map to the award’s <code>.id</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Map to the contract’s <code>.value.amount</code></p>
      ...
      <tr>
        ...
        <td>
<p><a href="../../operations/#add-a-bids-statistic">Add a bids statistic</a>, set its <code>.measure</code> to ‘lowestValidBidValue’, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p><a href="../../operations/#add-a-bids-statistic">Add a bids statistic</a>, set its <code>.measure</code> to ‘highestValidBidValue’, set its <code>.relatedLot</code> to the award’s only <code>.relatedLots</code> entry, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>For the <em>Lowest offer</em> and <em>Highest offer</em>, map to the bid statistic’s <code>.currency</code>.</p>
      ...
      <tr>
        ...
        <td>
<p>Set the award’s <code>.hasSubcontracting</code> to <code>true</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <td>
<p>Map to the award’s <code>.subcontracting.value.amount</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to the award’s <code>.subcontracting.value.currency</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to the award’s <code>.subcontracting.minimumPercentage</code> and <code>.subcontracting.maximumPercentage</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to the award’s <code>.subcontracting.description</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <td>
<p>Set the award’s <code>.subcontracting.competitive</code> to <code>true</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        <td colspan="2" id="/AWARD_CONTRACT/AWARDED_CONTRACT/DIRECTIVE_2009_81_EC/PCT_RANGE_SHARE_SUBCONTRACTING">
      ...
      <tr>
        ...
        <td>
<p>Map to the award’s <code>.subcontracting.competitiveMinimumPercentage</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to the award’s <code>.subcontracting.competitiveMaximumPercentage</code></p>
        </td>
      </tr>
  </table>
</div>
...
<p>For each of the following, add a <code>Classification</code> object to the <code>tender.procurementMethodRationaleClassifications</code> array. Set the classification’s <code>.scheme</code> to ‘TED_PT_AWARD_CONTRACT_WITHOUT_CALL’, and set its <code>.id</code> and <code>.description</code> as follows</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_PROC_OPEN’ and <code>.description</code> to ‘No tenders or no suitable tenders/requests to participate in response to open procedure’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_PROC_RESTRICTED’ and <code>.description</code> to ‘No tenders or no suitable tenders/requests to participate in response to restricted procedure’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_MANUF_FOR_RESEARCH’ and <code>.description</code> to ‘The products involved are manufactured purely for the purpose of research, experiment, study or development under the conditions stated in the directive’</p>
        </td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_TECHNICAL’ and <code>.description</code> to ‘The works, supplies or services can be provided only by a particular economic operator due to absence of competition for technical reasons’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_ARTISTIC’ and <code>.description</code> to ‘The works, supplies or services can be provided only by a particular economic operator due to procurement aiming at the creation or acquisition of a unique work of art or artistic performance’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_PROTECT_RIGHTS’ and <code>.description</code> to ‘The works, supplies or services can be provided only by a particular economic operator due to protection of exclusive rights, including intellectual property rights’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_EXTREME_URGENCY’ and <code>.description</code> to ‘Extreme urgency brought about by events unforeseeable for the contracting authority/entity and in accordance with the strict conditions stated in the directive’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_ADD_DELIVERIES_ORDERED’ and <code>.description</code> to ‘Additional deliveries by the original supplier ordered under the strict conditions stated in the directive’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_REPETITION_EXISTING’ and <code>.description</code> to ‘New works/services, constituting a repetition of existing works/services and ordered in accordance with the strict conditions stated in the directive’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_CONTRACT_AWARDED_DESIGN_CONTEST’ and <code>.description</code> to ‘Service contract to be awarded to the winner or one of winners under the rules of a design contest’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_COMMODITY_MARKET’ and <code>.description</code> to ‘Procurement of supplies quoted and purchased on a commodity market’</p>
        </td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_FROM_WINDING_PROVIDER’ and <code>.description</code> to ‘Purchase of supplies or services on particularly advantageous terms from a supplier which is definitively winding up its business activities’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_FROM_LIQUIDATOR_CREDITOR’ and <code>.description</code> to ‘Purchase of supplies or services on particularly advantageous terms from the liquidator in an insolvency procedure, an arrangement with creditors or a similar procedure under national laws and regulations’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>For each of the following, add a <code>Classification</code> object to the <code>tender.procurementMethodRationaleClassifications</code> array. Set the classification’s <code>.scheme</code> to ‘TED_PT_AWARD_CONTRACT_WITHOUT_CALL’, and set its <code>.id</code> and <code>.description</code> as follows</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_NO_TENDERS_REQUESTS’ and <code>.description</code> to ‘No tenders or no suitable tenders/requests to participate in response to a procedure with prior call for competition’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_PURE_RESEARCH’ and <code>.description</code> to ‘The contract involved is purely for the purpose of research, experiment, study or development under the conditions stated in the directive’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>.id</code> to ‘D_FROM_LIQUIDATOR_CREDITOR’ and <code>.description</code> to ‘Purchase of supplies or services on particularly advantageous terms from the liquidator in an insolvency procedure, an arrangement with creditors or a similar procedure under national laws and regulations’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_BARGAIN_PURCHASE’ and <code>.description</code> to ‘Bargain purchase taking advantage of a particularly advantageous opportunity available for a very short time at a price considerably lower than market prices’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>.id</code> to ‘D_PROC_RESTRICTED’ and <code>.description</code> to ‘No tenders or no suitable tenders/requests to participate in response to restricted procedure’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_PROC_NEGOTIATED_PRIOR_CALL_COMPETITION’ and <code>.description</code> to ‘No tenders or no suitable tenders/requests to participate in response to negotiated procedure with prior publication of a contract notice’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_PROC_COMPETITIVE_DIALOGUE’ and <code>.description</code> to ‘No tenders or no suitable tenders/requests to participate in response to competitive dialogue’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_OTHER_SERVICES’ and <code>.description</code> to ‘The contract concerns research and development services other than those referred to’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>.id</code> to ‘D_MANUF_FOR_RESEARCH’ and <code>.description</code> to ‘The products involved are manufactured purely for the purpose of research, experiment, study or development under the conditions stated in the directive’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_ALL_TENDERS’ and <code>.description</code> to ‘All tenders submitted in reply to a restricted procedure, negotiated procedure with prior publication of a contract notice or competitive dialogue were irregular or unacceptable. Only those tenderers were included in the negotiations which have satisfied the qualitative selection criteria’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>.id</code> to ‘D_PROTECT_RIGHTS’ and <code>.description</code> to ‘The works, supplies or services can be provided only by a particular economic operator due to protection of exclusive rights, including intellectual property rights’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_PERIODS_INCOMPATIBLE’ and <code>.description</code> to ‘The periods for the restricted procedure and the negotiated procedure with prior publication of a contract notice are incompatible with the urgency resulting from a crisis’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>.id</code> to ‘D_FROM_LIQUIDATOR_CREDITOR’ and <code>.description</code> to ‘Purchase of supplies or services on particularly advantageous terms from the liquidator in an insolvency procedure, an arrangement with creditors or a similar procedure under national laws and regulations’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_MARITIME_SERVICES’ and <code>.description</code> to ‘Contract related to the provision of air and maritime transport services for the armed forces of a Member State deployed or to be deployed abroad, under the strict conditions stated in the directive’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Map to <code>tender.procurementMethodRationale</code></p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘D_SERVICES_LISTED’ and <code>.description</code> to ‘The contract has as its object services listed in Annex II B to the directive’</p>
        </td>
      </tr>
      <tr>
        <td></td>
