...
<p>Map to the lot’s <code>.contractPeriod.durationInDays</code></p>
      ...
      <tr>
        ...
        <td>
<p>Add an <code>EssentialAsset</code> object to the <code>tender.essentialAssets</code> array, and map to its <code>.description</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add an <code>EssentialAsset</code> object to the <code>tender.essentialAssets</code> array, and map to its <code>.significance</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>tender.hasEssentialAssets</code> to <code>false</code></p>
      ...
      <tr>
        ...
        <td>
<p>Add an <code>EssentialAsset</code> object to the <code>tender.essentialAssets</code> array, and map to its <code>.predominance</code></p>
        </td>
      </tr>
  </table>
</div>
