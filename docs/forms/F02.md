...
**Quick links:** [PDF form](../_static/pdf/EN_F02.pdf) | [sample XML](https://github.com/open-contracting/european-union-support/blob/main/output/samples/F02_2014.xml)
...
<p>Map to the lot’s <code>.options.description</code></p>
      ...
      <tr>
        ...
        <td>
<p>Set the lot’s <code>.submissionTerms.electronicCatalogPolicy</code> to ‘required’.</p>
        </td>
      </tr>
      <tr>
...
<p>Set <code>tender.secondStage.successiveReduction</code> to <code>true</code></p>
      ...
      <tr>
        ...
        <td colspan="2">
          <p>Information about negotiation <i>(only for competitive procedures with negotiation)</i></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>tender.secondStage.noNegotiationNecessary</code> to <code>true</code></p>
        </td>
      </tr>
      <tr>
