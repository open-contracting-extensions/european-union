...
<p>Set <code>tender.legalBasis.scheme</code> to ‘CELEX’, and map to <code>tender.legalBasis.id</code></p>
      ...
      <tr>
        ...
        <td colspan="2" id="/NOTICE">
          <p><i>Unlabeled</i><br><code>/NOTICE</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add ‘planning’ to <code>tag</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add ‘planning’ to <code>tag</code>. If unchecked, set <code>tender.status</code> to ‘planned’. If checked, add ‘tender’ to <code>tag</code>, and set <code>tender.status</code> to ‘active’.</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Add ‘planning’ to <code>tag</code>. If unchecked, set <code>tender.status</code> to ‘planned’. If checked, add ‘tender’ to <code>tag</code>, and set <code>tender.status</code> to ‘active’.</p>
      ...
      <tr>
        ...
        <td>
<p>Add ‘tender’ to <code>tag</code>, and set <code>tender.status</code> to ‘active’.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add ‘award’ and ‘contract’ to <code>tag</code>. If the notice has one or more <code>/AWARD_CONTRACT/AWARDED_CONTRACT</code> (<em>A contract/lot is awarded</em>) elements, set <code>tender.status</code> to ‘complete’. Otherwise, if the notice has one or more <code>/AWARD_CONTRACT/NO_AWARDED_CONTRACT/PROCUREMENT_UNSUCCESSFUL</code> (<em>No tenders or requests to participate were received or all were rejected</em>) elements, set <code>tender.status</code> to ‘unsuccessful’. Otherwise, set <code>tender.status</code> to ‘cancelled’.</p>
        </td>
      </tr>
  </table>
</div>
...
<p>Map to the lot’s <code>.contractPeriod.endDate</code></p>
      ...
      <tr>
        ...
        <td colspan="2" id="/OBJECT_CONTRACT/OBJECT_DESCR/QS">
...
<p>Map to the lot’s <code>.contractPeriod.endDate</code></p>
      ...
      <tr>
        ...
        <td>
<p>Discard. If the lot’s <code>.contractPeriod</code> isn’t set, then the duration is indefinite.</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>tender.contractTerms.reservedExecution</code> to <code>true</code></p>
      ...
      <tr>
        ...
        <td>
<p>Add ‘publicServiceMissionOrganization’ to the <code>tender.otherRequirements.reservedParticipation</code> array</p>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
<p>Add to the <code>tender.otherRequirements.qualificationSystemConditions</code> array</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add to the <code>tender.otherRequirements.qualificationSystemMethods</code> array</p>
        </td>
      </tr>
      <tr>
...
<p>Set <code>tender.procurementMethod</code> to ‘selective’, and set <code>tender.procurementMethodDetails</code> to ‘Restricted procedure’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>tender.procurementMethod</code> to ‘selective’, and set <code>tender.procurementMethodDetails</code> to ‘Procedure involving negotiations’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Map to <code>tender.techniques.frameworkAgreement.periodRationale</code></p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>tender.procedure.features</code></p>
        </td>
      </tr>
      <tr>
...
<p>Map to <code>tender.awardCriteriaDetails</code></p>
      ...
      <tr>
        ...
        <td id="/PROCEDURE/NOTICE_NUMBER_OJ">
          <p>Notice number in the OJ S <i>(One of the following)</i> <i>(Periodic indicative notice)</i> <i>(Notice on a buyer profile)</i> <i>(Qualification system – utilities)</i> <i>(One of the following)</i> <i>(Periodic indicative notice used as a call for competition)</i> <i>(Contract notice)</i> <i>(Qualification system used as a call for competition)</i> <i>(Voluntary ex ante transparency notice)</i><br><code>/PROCEDURE/NOTICE_NUMBER_OJ</code></p>
        </td>
        <td>
