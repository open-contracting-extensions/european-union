...
<p>Set <code>tender.procurementMethod</code> to ‘open’, and set <code>tender.procurementMethodDetails</code> to ‘Open procedure’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>tender.procedure.isAccelerated</code> to <code>true</code>, and map to <code>tender.procedure.acceleratedRationale</code></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>tender.procurementMethod</code> to ‘selective’, and set <code>tender.procurementMethodDetails</code> to ‘Restricted procedure’</p>
      ...
      <tr>
        ...
        <td>
          <p><a href="#/PROCEDURE/ACCELERATED_PROC">Same as <i>Justification</i> above</a></p>
<p>Set <code>tender.procedure.isAccelerated</code> to <code>true</code>, and map to <code>tender.procedure.acceleratedRationale</code></p>
        </td>
      </tr>
      <tr>
        ...
        <td>
<p>Set <code>tender.procurementMethod</code> to ‘selective’, and set  <code>tender.procurementMethodDetails</code> to ‘Competitive procedure with negotiation’</p>
        </td>
      </tr>
      <tr>
        <td></td>
