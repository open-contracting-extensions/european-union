...
**Quick links:** [PDF form](../_static/pdf/EN_F05.pdf) | [sample XML](https://github.com/open-contracting/european-union-support/blob/main/output/samples/F05_2014.xml)
...
<p>Set <code>tender.contractTerms.reservedExecution</code> to <code>true</code></p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>tender.submissionTerms.depositsGuarantees</code></p>
        </td>
      </tr>
      <tr>
