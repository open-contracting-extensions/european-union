...
<p>For each <code>CATEGORY</code> element, add a <code>Classification</code> object to the <code>tender.additionalClassifications</code> array, set its <code>.scheme</code> to ‘TED_CATEGORY’, and set its <code>.id</code> and <code>.description</code> as follows:</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘01’, and set <code>.description</code> to ‘Rail transport services’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>.id</code> to ‘02’, ‘Inland waterway and set <code>.description</code> to and maritime transport services’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘03’, and set <code>.description</code> to ‘Metro transport services’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘04’, and set <code>.description</code> to ‘Tram transport services’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘05’, and set <code>.description</code> to ‘Bus transport services (urban/regional)’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘06’, and set <code>.description</code> to ‘Coach transport services (long-distance)’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>.id</code> to ‘07’, and set <code>.description</code> to ‘Trolleybus transport services’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Set <code>.id</code> to ‘08’,  and set <code>.description</code> to ‘Light rail transport services’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>.id</code> to ‘99’, and set <code>.description</code> to ‘Other transport services’</p>
        </td>
      </tr>
      <tr>
        <td id="II.2">II.2</td>
