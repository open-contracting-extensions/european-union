...
<p>Add a <code>SelectionCriterion</code> object to the <code>tender.selectionCriteria.criteria</code> array, set its <code>.type</code> to ‘suitability’, and map to its <code>.description</code>.</p>
      ...
      <tr>
        ...
        <td>
<p>Add a <code>SelectionCriterion</code> object to the <code>tender.selectionCriteria.criteria</code> array, set its <code>.type</code>code> to ‘economic’, and set its <code>.description</code> to “As stated in the procurement documents”.</p>
        </td>
      </tr>
      <tr>
        <td></td>
