...
<p>This assumes the contract award notice set <code>/AWARD_CONTRACT/CONTRACT_NO</code> and that the <em>Contract No</em> is unique within the contracting process. <span class="badge badge-warning"><a href="https://github.com/open-contracting-extensions/european-union/issues/92">Attention #92</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
