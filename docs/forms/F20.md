...
**Quick links:** [PDF form](../_static/pdf/EN_F20.pdf) | [sample XML](https://github.com/open-contracting/european-union-support/blob/main/output/samples/F20_2014.xml)
...
<p>This assumes the contract award notice set <code>/AWARD_CONTRACT/CONTRACT_NO</code> and that the <em>Contract No</em> is unique within the contracting process. <span class="badge badge-warning"><a href="https://github.com/open-contracting-extensions/european-union/issues/93">Attention #93</a></span></p>
        </td>
      </tr>
      <tr>
        <td></td>
