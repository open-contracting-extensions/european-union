...
<p><em>This results in a loss of structure if *to the following address</em> is selected.* <span class="badge badge-warning">Attention</span></p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p><em>This results in a loss of structure if *electronically via</em> is checked.* <span class="badge badge-warning">Attention</span></p>
        </td>
      </tr>
      <tr>
        <td></td>
