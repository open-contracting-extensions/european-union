  ...
  <table class="docutils">
    ...
    <tbody>
      <tr>
        <td></td>
        <td id="/NOTICE/@TYPE">
          <p>This notice is for prior information only<br><code>/NOTICE/@TYPE</code>is <code>PRI_ONLY</code></p>
        </td>
        <td>
...
<p>This is equivalent to a <a href="https://www.wto.org/english/docs_e/legal_e/rev-gpr-94_01_e.htm#_Toc320546103">notice of planned procurement</a> in the GPA.</p>
      ...
      <tr>
        <td></td>
        <td id="/NOTICE/@TYPE">
          <p>This notice aims at reducing time limits for receipt of tenders<br><code>/NOTICE/@TYPE</code>is <code>PRI_REDUCING_TIME_LIMITS</code></p>
        </td>
        <td>
<p>Add ‘planning’ to <code>tag</code></p>
...
<p>Add a <code>Renewals</code> object to the <code>tender.renewals</code> array, and set its <code>.id</code>. If the contract is divided into lots, set its <code>.relatedLot</code> to the lot’s <code>.id</code>. <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/22">#22</a></span></p>
      ...
      <tr>
        ...
        <td>
<p>Set the renewals’ <code>.description</code> <span class="badge badge-proposal">Proposal <a href="https://github.com/open-contracting-extensions/european-union/issues/22">#22</a></span></p>
        </td>
      </tr>
      <tr>
        <td>II.2.10</td>
