  ...
  <table class="docutils">
    ...
    <tbody>
      ...
      <tr>
        <td>D4.1</td>
        <td colspan="2">
          <p>Justification for the award of the concession without publication of a concession notice in accordance with Article 31(4) and (5) of Directive 2014/23/EU</p>
        </td>
      </tr>
      <tr>
        <td></td>
