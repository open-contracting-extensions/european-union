...
<p>Map to the award’s <code>.date</code></p>
      ...
      <tr>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘bids’, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘smeBids’, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Add a <code>BidsStatistic</code> object to the <code>bids.statistics</code> array, set its <code>.id</code> (string), set its <code>.measure</code> to ‘foreignBidsFromEU’, and map to its <code>.value</code>.</p>
        </td>
      </tr>
      <tr>
        <td></td>
