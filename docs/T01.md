...
<p>For each <code>CODE</code> attribute, add a <code>Classification</code> object to the <code>tender.additionalClassifications</code> array, set its <code>.scheme</code> to ‘CPVS’, prefix by the <em>Main CPV code</em>, and map to its <code>.id</code>. Remove any duplicate entries from the <code>tender.additionalClassifications</code> array.</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>tender.mainProcurementCategory</code> to ‘services’</p>
        </td>
      </tr>
      <tr>
        <td></td>
...
<p>Map to ‘services’</p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>.id</code>, and set <code>.description</code> to ‘Rail transport services</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>, ‘Inland waterway and set <code>.description</code> to and maritime transport services</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>, and set <code>.description</code> to ‘Metro transport services</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>, and set <code>.description</code> to ‘Tram transport services</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>, ‘Bus transport and set <code>.description</code> to services (urban/regional)</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>, ‘Coach transport and set <code>.description</code> to services (long-distance)</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>, and set <code>.description</code> to ‘Trolleybus transport services</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>,  and set <code>.description</code> to’Light rail transport services</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>, and set <code>.description</code> to ‘Other transport services</p>
        </td>
      </tr>
      <tr>
        <td id="II.2">II.2</td>
...
<p>Set <code>tender.procurementMethod</code> to ‘open’, and set <code>tender.procurementMethodDetails</code> to ‘Competitive tendering procedure’</p>
      ...
      <tr>
        ...
        <td>
<p>Set <code>tender.procurementMethod</code> to ‘direct’, and set <code>tender.procurementMethodDetails</code> to ‘Direct award to an internal operator (art. 5(2) of 1370/2007)’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>tender.procurementMethod</code> to ‘direct’, and set <code>tender.procurementMethodDetails</code> to ‘Direct award of a small scale contract (art. 5(4) of 1370/2007)’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>tender.procurementMethod</code> to ‘direct’, and set <code>tender.procurementMethodDetails</code> to ‘Direct award of a small scale contract to a small and medium sized enterprise (art. 5(4) of 1370/2007, 2nd paragraph)’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Set <code>tender.procurementMethod</code> to ‘direct’, and set <code>tender.procurementMethodDetails</code> to ‘Direct award for railway transport (art. 5(6) of 1370/2007)’</p>
        </td>
      </tr>
  </table>
</div>
