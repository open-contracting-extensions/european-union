...
<p>Map to <code>.id</code>, and set <code>.description</code> to ‘Tram transport services’</p>
      ...
      <tr>
        ...
        <td>
<p>Map to <code>.id</code>, and set <code>.description</code> to ‘Bus transport services (urban/regional)’</p>
        </td>
      </tr>
      <tr>
        <td></td>
        ...
        <td>
<p>Map to <code>.id</code>, and set <code>.description</code> to ‘Coach transport services (long-distance)’</p>
        </td>
      </tr>
      <tr>
        <td></td>
